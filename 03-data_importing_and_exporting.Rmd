...
### Overview of R functions to store data
After data wrangling, manipulation and processing, the end product(processed data) can be saved for further.future use. The data can also be share to others. R has several functions to write the processed data locally into either CSV, Excel, text or other file formats. 
